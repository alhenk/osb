...
public class Runner {
	public static void main(String[] args) throws XmlException {
		...
		/*
		 * 3 Put Data (message) into Queue and add header attribute and
		 * JMSPriority
		 */
		...
		/*
		 * 5 Consume the message from Queue with the attribute selector
		 * (messageType = 'messageMy')
		 */
		/*
		 * 6 Replace name space, remove prefixes 'test' and change attribute
		 * 'class' value on '06'
		 */
		...
		System.out.println("MESSAGE PROXY3:\n"
				+ (null == message ? "NO MESSAGE PROXY3" : messageProxy
						.xmlText(opts)));

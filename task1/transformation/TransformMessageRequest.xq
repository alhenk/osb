...
(:: pragma bea:global-element-return element="ns0:data" location="../xsd/data.xsd" ::)

declare namespace ns1 = "http://osb.tutorial.epam.com/MessageService";
declare namespace ns0 = "http://kz.cits.osb.com/test/registry";
declare namespace xf = "http://tempuri.org/task1/transformation/TransformMessageRequest/";

declare function xf:TransformMessageRequest($sendMessage1 as element(ns1:SendMessage))
    as element(ns0:data) {
...
xf:TransformMessageRequest($sendMessage1)
